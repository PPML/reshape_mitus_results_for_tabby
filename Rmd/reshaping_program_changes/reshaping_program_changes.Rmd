...
restab <- make_empty_res_tab(intvs = c('basecase', 'custom_scenario'), big_or_small = 'small')
...
restab <- make_empty_res_tab(intvs = c('basecase', 'custom_scenario'), big_or_small = 'big')
restab %<>% mutate_if(is.factor, as.integer) %>% as.matrix
